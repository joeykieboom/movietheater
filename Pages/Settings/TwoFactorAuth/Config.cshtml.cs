...
namespace dotnet_core_theater.Pages.Settings.TwoFactorAuth
{
    public class ConfigModel : PageModel
    {
        ...
        public ConfigModel(UserManager<UserModel> userManager, ILogger<ConfigModel> logger, UrlEncoder urlEncoder) 
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("dotnet_core_theater"),
