...
namespace dotnet_core_theater.Pages.Settings
{
    public class SecurityModel : PageModel
    {
        ...
        public SecurityModel(UserManager<UserModel> userManager, SignInManager<UserModel> signInManager, ILogger<IndexModel> logger) 
        {
